        ...
        <div class="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
            <div class="relative py-3 sm:max-w-xl sm:mx-auto">
                ...
                <div class="relative px-4 py-5 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                    <h1 class="text-2xl text-center">Edit Contact</h1>
                    <div class="max-w-md mx-auto">
                        <div class="overflow-hidden sm:rounded-md">
                            ...
                            <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                                ...
                                <button @click="update" type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    Update
                                </button>
                            </div>
                        </div>
...
export default {
    ...
    mounted(){
        axios.get('/api/contacts/' + this.$route.params.id + '/edit').then(response =>{
